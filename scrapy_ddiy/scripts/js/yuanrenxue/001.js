...
function oo0O0(mw) {
    ...
    for (var i = 0, len = window.a.length; i < len; i++) {
        ...
        var b_s = String[document.e + document.g](window.a[i][document.f + document.h]() - i - window.c);
        // console.log(b_s);
        window.b += b_s
    }
    ...
    eval(Buffer.from(window['b'], 'base64').toString()[J('0x0', ']dQW')](J('0x1', 'GTu!'), '\x27' + mw + '\x27'));
    return window.f
}
...
function get_m() {
    ...
    return oo0O0(timestamp.toString()) + '丨' + timestamp / 1000;
}
